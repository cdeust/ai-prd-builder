...
public struct CommandParser {
    ...
    public static func parse(_ input: String) -> ParsedCommand {
        ...
        if input.lowercased() == CommandConstants.Commands.exit {
        ...
        case CommandConstants.Commands.help: .help
        case CommandConstants.Commands.glossary: .glossary
        case CommandConstants.Commands.thinking: .thinking
        default: .unknown
        }
