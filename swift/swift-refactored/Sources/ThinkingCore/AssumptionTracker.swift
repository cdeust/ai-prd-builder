...
public class AssumptionTracker {
    ...
    public func extractAssumptions(from reasoning: String) async throws -> [TrackedAssumption] {
        ...
        let response = try await queryOrchestrator(prompt: prompt, thinkingMode: .convergentThinking)
    ...
    public func validateAssumption(
        ...
        let response = try await queryOrchestrator(prompt: prompt, thinkingMode: .criticalAnalysis)
    ...
    public func assessImpact(of assumption: TrackedAssumption) async throws -> TrackedAssumption.ImpactAssessment {
        ...
        let response = try await queryOrchestrator(prompt: prompt, thinkingMode: .systemsThinking)
    ...
    public func findContradictions() async throws -> [Contradiction] {
        ...
        let response = try await queryOrchestrator(prompt: prompt, thinkingMode: .parallelExploration)
    ...
    private func queryOrchestrator(prompt: String, thinkingMode: ThinkingModeManager.ThinkingMode = .criticalAnalysis) async throws -> String {
