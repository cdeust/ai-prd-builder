...
public struct DeviceCapabilities {
    ...
    public static func probe() -> DeviceCapabilities {
        #if os(macOS)
        var size = 0
        sysctlbyname(AIProviderConstants.DeviceCapabilities.hardwareKey, nil, &size, nil, 0)
        ...
        let osVersion = String(format: AIProviderConstants.DeviceCapabilities.osVersionFormat,
        ...
        return DeviceCapabilities(
            ...
            supportsPCC: false,
            osVersion: AIProviderConstants.DeviceCapabilities.iosVersion,
            availableMemoryGB: 4
        )
        #endif
    }
